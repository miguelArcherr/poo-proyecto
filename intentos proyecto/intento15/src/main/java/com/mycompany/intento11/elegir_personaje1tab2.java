 ...
 * @author miguel
 */
public class elegir_personaje1tab2 extends javax.swing.JFrame {
    ...
    private void j1p1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_j1p1ActionPerformed
       ...
       font.setIcon(new ImageIcon("src/main/java/fondo/fondo-tiradas.png"));
        ...
        tablero2_1 T12 = new tablero2_1(modelo1);
        T12.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(elegir_personaje1tab2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new elegir_personaje1tab2().setVisible(true);
            }
        });
    }
