...
public class tablero2 extends javax.swing.JFrame {
    ...
    private tablero2(){
            ...
            switch (L) {
                ...
                case 17 -> {
                    if (L == 17) {
                        ...
                        if (L==17){serp2=serp2+1;}
        
                        L = L - 13;
                        JOptionPane.showMessageDialog(null, "retrocedes 3 espacios");
                        cases();
                        cas13.setIcon(personaje2);
                    }
                }
                ...
                case 20 -> {
                    if (L == 20) {
                      ...
                      if (L==20){esca2= esca2+1;}

                        L = L + 9;
                            JOptionPane.showMessageDialog(null, "avanzas 9 espacios");
                            cases();
     ...
     public void pieza1bt2() {
      ...
      public tablero2(numero_imagen modelo) {
        this.modelo = modelo;
          num2 = modelo.getNum2();
         num1 = modelo.getNum1();
        initComponents();
    ...
    private void initComponents() {
        ...
        tirar2.setText("tirar");
        tirar2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tirar2ActionPerformed(evt);
            }
        });
        jPanel1.add(tirar2, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 310, -1, -1));
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 270, 140, 30));

        dadop1.setFont(new java.awt.Font("Old English Text MT", 1, 48)); // NOI18N
        dadop1.setForeground(new java.awt.Color(0, 255, 255));
        dadop1.setText("   0");
        jPanel1.add(dadop1, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 160, 100, 100));

        dadop2.setFont(new java.awt.Font("Old English Text MT", 1, 48)); // NOI18N
        dadop2.setForeground(new java.awt.Color(255, 255, 0));
        dadop2.setText("   0");
        jPanel1.add(dadop2, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 360, 100, 100));
